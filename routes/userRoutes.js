...
// User get appointments locked behind token login
...
router.get('/users/appointments', passport.authenticate('jwt'), (req, res) => {
  
  Appointment.findById(req.user.appointments)
    .populate('user')
